    ...
    create() {
        ...
        for (let i = 0; i < Consumable.Consumables.length; i++) {
            const button = this.add
                ...
                this.invokeTooltip(150 + 125 * i, 375, Consumable.Consumables[i].tooltip);
            })
            ...
            const costText = this.add.text(button.x, button.y + 100, Consumable.Consumables[i].cost.toString());
        }
    }
    updateMoneyText() {
